...
namespace Basket.UnitTest
{
    ...
    internal class BasketServiceTests
    {
        ...
        public async Task GetBasketReturnsEmptyForNoUser()
        {
            ...
            var service = new BasketService.Api.Grpc.BasketService(mockRepository, NullLogger<BasketService.Api.Grpc.BasketService>.Instance);
