...
namespace EventBus.Base.Events
{
    public abstract class BaseEventBus : IEventBus
    {
        ...
        public abstract Task Publish(IntegrationEvent @event, CancellationToken cancellationToken = default);
        ...
        public abstract Task UnSubscribe<T, TH>(CancellationToken cancellationToken = default) where T : IntegrationEvent where TH : IIntegrationEventHandler<T>;
