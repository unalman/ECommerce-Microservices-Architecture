...
namespace OrderService.Infrastructure.Migrations
{
    ...
    [Migration("20260125013345_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OrderService.Infrastructure.Idempotency.ClientRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("OrderService.Domain.AggregateModels.OrderAggregate.Order", b =>
                {
                    ...
                    b.HasOne("OrderService.Domain.AggregateModels.BuyerAggregate.PaymentMethod", null)
                        .WithMany()
